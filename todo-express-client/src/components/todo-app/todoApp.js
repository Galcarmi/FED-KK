...
const styles = {
  ...
  todoApp__inputContainer :{
    ...
    position: 'fixed',
    width:`${100-(fractionalStylesConstants.sideMarginBigPercent.quantity * 2)}${fractionalStylesConstants.sideMarginBigPercent.unit}`,
    bottom:0,
    zIndex: 1000,
    backgroundColor: fullStylesConstants.colors.white,
  },
  '@media only screen and (max-width: 600px)':{
    todoApp__inputContainer: {
      width:`${100-(fractionalStylesConstants.sideMarginMediumPercent.quantity * 2)}${fractionalStylesConstants.sideMarginMediumPercent.unit}`,
    },
  },
  '@media only screen and (max-width: 400px)':{
    todoApp__inputContainer: {
      width:`${100-(fractionalStylesConstants.sideMarginSmallPercent.quantity * 2)}${fractionalStylesConstants.sideMarginSmallPercent.unit}`,
    },
  },
